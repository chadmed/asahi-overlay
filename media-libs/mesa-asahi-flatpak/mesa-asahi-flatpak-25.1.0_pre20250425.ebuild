...
2408? (
	https://download.copr.fedorainfracloud.org/results/@asahi/flatpak/fedora-${FEDORA_MAJOR}-aarch64/08987807-mesa-asahi-24.08-flatpak/mesa-asahi-24.08-flatpak-$(ver_cut 1-3)~asahipre$(ver_cut 5)-2.aarch64.rpm -> ${P}-2408.rpm
)
"
