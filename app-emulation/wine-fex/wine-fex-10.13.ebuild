...
BYLAWS_COMMIT_SHA1="a6844d10622fc1a973ec1f22fc4f78a0fcd6cb29"
...
if [[ ${PV} == 9999 ]]; then
	...
	SRC_URI="https://github.com/bylaws/wine/archive/${BYLAWS_COMMIT_SHA1}.tar.gz -> ${PN}-${PV}.tar.gz"
	S=${WORKDIR}/wine-${BYLAWS_COMMIT_SHA1}
	KEYWORDS="-* ~arm64"
fi

DESCRIPTION="Free implementation of Windows(tm) on Unix, with FEX-related patches"
HOMEPAGE="
