...
DRM_HEADERS_HASH="0675d2f2910b46ba7e0fb9d6dff86f8d82b05660"
...
SRC_URI="
	...
	https://github.com/FEX-Emu/drm-headers/archive/${DRM_HEADERS_HASH}.tar.gz -> drm-headers-${DRM_HEADERS_HASH}.tar.gz
	thunks? (
...
PATCHES="
	...
	${FILESDIR}/${P}-cpp-optparse-path.patch
"
...
src_unpack() {
	...
	local -A deps=(
		...
		drm-headers "drm-headers-${DRM_HEADERS_HASH}"
	)
