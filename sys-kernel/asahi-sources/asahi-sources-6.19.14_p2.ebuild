...
# 82961749e651 ("kernel-2.eclass: Ensure genpatches has the intended linux
# patch ver") is broken with UNIPATCH_STRICTORDER="yes"
# We need UNIPATCH_STRICTORDER="yes" but in the case of 6.19.14_p2 it works without
