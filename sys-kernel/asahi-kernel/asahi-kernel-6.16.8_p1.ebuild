...
src_prepare() {
	...
	eapply "${FILESDIR}/${PN}-Revert-Add-asahi-localversion-to-05-asahi.localversi.patch"
	...
	merge_configs+=(
		"${FILESDIR}"/linux-6.16_arm64_deselect_non_apple_arch.config
	)
	...
	merge_configs+=(
		"${FILESDIR}"/linux-6.16.4_apple_silicon_base.config
	)
